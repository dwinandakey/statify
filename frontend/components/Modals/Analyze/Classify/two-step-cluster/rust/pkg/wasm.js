...
export class TwoStepClusterAnalysis {
     ...
     */
    get_all_log() {
        const ret = wasm.twostepclusteranalysis_get_all_log(this.__wbg_ptr);
        if (ret[2]) {
...
if (Symbol.dispose) TwoStepClusterAnalysis.prototype[Symbol.dispose] = TwoStepClusterAnalysis.prototype.free;
...
const TwoStepClusterAnalysisFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_twostepclusteranalysis_free(ptr, 1));
