...
if (Symbol.dispose) HierarchicalCluster.prototype[Symbol.dispose] = HierarchicalCluster.prototype.free;
...
const HierarchicalClusterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hierarchicalcluster_free(ptr, 1));
