...
const KMeansClusterModal = lazy(
  () =>
    import("@/components/Modals/Analyze/Classify/k-means-cluster/dialogs/k-means-cluster-main"),
);
const KMedoidsClusterModal = lazy(
  () =>
    import("@/components/Modals/Analyze/Clustering/k-medoids-cluster/dialogs/k-medoids-cluster-main"),
);
