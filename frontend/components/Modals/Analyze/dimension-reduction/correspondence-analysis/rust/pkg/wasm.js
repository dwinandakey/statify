...
if (Symbol.dispose) CorrespondenceAnalysis.prototype[Symbol.dispose] = CorrespondenceAnalysis.prototype.free;
...
const CorrespondenceAnalysisFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_correspondenceanalysis_free(ptr, 1));
