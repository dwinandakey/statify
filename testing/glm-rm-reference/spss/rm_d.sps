* Dataset (d) = data (b) dengan kontras Repeated, waktu 4 level x kelompok 3 grup.
...
OUTPUT EXPORT /CONTENTS EXPORT=ALL LAYERS=VISIBLE MODELVIEWS=PRINTSETTING
  /XLSX DOCUMENTFILE='D:\0.POLTSTAT STIS\Tugas Kuliah\Skripsi\topik baru statify\statify64\testing\glm-rm-reference\spss-output\rm_d.xlsx' OPERATION=CREATEFILE.
